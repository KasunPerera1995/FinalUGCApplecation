    ...
    public partial class NotificationReview : Form
    {
        ...
        public void NotificationLoad() {
            try
            {
                ...
                MySqlDataAdapter sql = new MySqlDataAdapter("select PaymentID,OwnerID,PaymentValue,PaymentMonth,PaymentYear,PaymentBank,AccountNo,PaymentSubDate,VoucherNo,Type,ApprovedDate from PensionScheme.PensionPayment p where Approval='0'", conn);
